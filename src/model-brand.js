...
const brands = {
  'inception': ['inception.svg', 'Inception'],
  'ibm-granite': ['ibm.svg', 'IBM'],
  'bytedance-seed': ['bytedance-color.svg', 'ByteDance'],
  'bytedance': ['bytedance-color.svg', 'ByteDance'],
  'liquid': ['liquid.svg', 'Liquid AI'],
  'upstage': ['upstage-color.svg', 'Upstage'],
  'poolside': ['poolside-color.svg', 'Poolside'],
  'meituan': ['longcat-color.svg', 'LongCat'],
  'kwaipilot': ['kwaipilot-color.svg', 'KwaiPilot'],
  'aion-labs': ['aionlabs-color.svg', 'Aion Labs'],
  'cohere': ['cohere-color.svg', 'Cohere'],
  'mistralai': ['mistral-color.svg', 'Mistral AI'],
  'relace': ['relace.svg', 'Relace'],
  'amazon': ['aws-color.svg', 'Amazon Web Services'],
  'perplexity': ['perplexity-color.svg', 'Perplexity'],
  'nousresearch': ['nousresearch.svg', 'Nous Research'],
  'morph': ['morph-color.svg', 'Morph'],
  'baidu': ['wenxin-color.svg', 'ERNIE'],
  'microsoft': ['microsoft-color.svg', 'Microsoft'],
